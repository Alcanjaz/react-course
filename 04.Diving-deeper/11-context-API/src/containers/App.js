...
class App extends Component {
  ...
  constructor(props) {
    //The component's constructor receive props and initialize the state
    ...
    if (this.state.showPersons === true) {
      persons = (
        <Persons
          ...
          isAuthenticated={this.state.logged}
        />
      );
    }
    ...
    return (
      <Aux classes={styles.App}>
        ...
        <authContext.Provider
          value={{ authenticated: this.state.logged, login: this.loginHandler }}
        >
